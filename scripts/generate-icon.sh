...
swift "$ROOT_DIR/scripts/generate-icon.swift" "$WORK_DIR/icon_1024.png"
...
iconutil -c icns "$ICONSET" -o "$ROOT_DIR/Packaging/AppIcon.icns"
echo "Wrote $ROOT_DIR/Packaging/AppIcon.icns"
