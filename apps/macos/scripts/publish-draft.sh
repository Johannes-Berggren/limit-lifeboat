...
assert_plist_value "$INFO" LimitLifeboatAppVariant "distribution"
assert_plist_value "$INFO" LimitLifeboatApplicationSupportDirectoryName "LimitLifeboat"
assert_plist_value "$INFO" LimitLifeboatCredentialService "com.limitlifeboat.app.credentials"
